...
const AddOrUpdateStudent = () => {
    ...
    const { formData, addAPIStatus, updateAPIStatus } = useSelector(state => state?.student)
    ...
    return (
        <Grid>
            <Layout1 title={languageData.pages.studentManagement?.[state?.mode].header}>
                <Formik
                    autoComplete='off'
                    enableReinitialize
                    ...
                    {({
                        ...
                        >
                            <Grid container direction='column' spacing={20} mb={20}>
                                <Grid item xs={12} >
                                    <TextInput
                                        label={languageData.pages.studentManagement.form.id.label}
                                        fieldId={'id'}
                                        errors={errors}
                                        touched={touched}
                                        disabled
                                ...
                                <Grid item xs={12} >
                                    <TextInput
                                        label={languageData.pages.studentManagement.form.name.label}
                                        fieldId={'name'}
                                        errors={errors}
                                        touched={touched}
                                    />
                                ...
                                <Grid item xs={12} >
                                    <TextInput
                                        type='password'
                                        label={languageData.pages.studentManagement.form.password.label}
                                        fieldId={'password'}
                                        errors={errors}
                                        touched={touched}
                                    />
